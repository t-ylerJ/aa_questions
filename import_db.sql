...
INSERT INTO
  users (fname, lname)
VALUES
  ("Ned", "Tyler"), ("Kush", "Patel"), ("Earl", "Jerry");
...
FROM
  users
WHERE
  users.fname = "Ned" AND users.lname = "Tyler";
...
FROM
  users
WHERE
  users.fname = "Earl" AND users.lname = "Jerry";
...
VALUES
  ((SELECT id FROM users WHERE fname = "Ned" AND lname = "Tyler"),
